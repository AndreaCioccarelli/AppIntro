...
public class CustomBackgroundIntro extends AppIntro {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        sliderPage1.setImageDrawable(R.drawable.instagram);
        ...
        sliderPage2.setImageDrawable(R.drawable.intro_instagram);
        ...
        sliderPage3.setImageDrawable(R.drawable.intro_secure);
        ...
        sliderPage4.setImageDrawable(R.drawable.intro_notifications);
